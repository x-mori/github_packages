Gem::Specification.new do |spec|
  ...
  spec.metadata = { 'github_repo' => 'ssh://github.com/x-mori/github_packages', 'source_uri' => 'https://github.com/x-mori/github_packages/tree/main/packages/rubygems/x-mori-port-check' }
  spec.bindir = 'bin'
