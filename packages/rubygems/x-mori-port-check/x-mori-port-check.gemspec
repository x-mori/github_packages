Gem::Specification.new do |spec|
  ...
  spec.metadata = { 'github_repo' => 'ssh://github.com/x-mori/minimori-packages', 'source_uri' => 'https://github.com/x-mori/minimori-packages/tree/main/packages/rubygems/x-mori-port-check' }
  spec.bindir = 'bin'
